...
- Intended for log forwarding from VCF-related systems such as ESX, NSX, and vCenter
...
- If `CA_PASSWORD_FILE` does not exist, it is generated automatically and stored under `CA_DATA_DIR`
...
- `keycloak.crt` contains the leaf certificate and intermediate chain as returned by step-ca
